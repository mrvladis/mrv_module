...
$DomainFQDN = 'mrvlab.local'
$EnGbDefaulturl = 'https://.blob.core.windows.net/1windowsupdatespublic/en-gb-default.reg'
$EnGbWelcomeurl = 'https://.blob.core.windows.net/1windowsupdatespublic/en-gb-welcome.reg'
$start_time = Get-Date
